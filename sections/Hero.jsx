      ...
      <div className="container mx-auto w-full h-full">
        <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between w-full h-full">
          <div className="flex flex-col items-center gap-5 lg:items-start">
           ...
           <div className="flex items-center gap-3 border border-secondary rounded-full p-3 shadow-md">
              <input type="search" placeholder="Search Doctor" className="outline-none "/>
              <BsSearch size={25} className="cursor-pointer" />
           </div>
          </div>

          <div>
            <Image src={main} alt="hero_image" className="w-[1285.36px]" />
          </div>
        </div>
      </div>
    </div>
